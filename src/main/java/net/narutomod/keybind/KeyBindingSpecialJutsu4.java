...
public class KeyBindingSpecialJutsu4 extends ElementsNarutomodMod.ModElement {
	private KeyBinding keys;
	private boolean wasKeyDown;

	public KeyBindingSpecialJutsu4(ElementsNarutomodMod instance) {
		super(instance, 100);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.specialjutsu4", Keyboard.KEY_C, "key.mcreator.category");
	...
	private static void pressAction(EntityPlayer entity, boolean is_pressed) {
		...
		if ((helmet.getItem() instanceof ItemDojutsu.Base))
			((ItemDojutsu.Base) helmet.getItem()).onJutsuKey4(is_pressed, helmet, entity);
	}
}

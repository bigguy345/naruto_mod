			...
			public void doRender(EC entity, double x, double y, double z, float f, float partialTicks) {
				...
				if (user != null) {
					...
					if (!flag1) {
						...
						if (!(entity instanceof Spear) && entity.ticksExisted % 4 == 0) {
							EntityLightningArc.spawnAsParticle(entity.world, vec0.x, vec0.y, vec0.z, entity.getGrowth(), 0d, 0d, 0d, 0xc00000ff, 4);
						}
